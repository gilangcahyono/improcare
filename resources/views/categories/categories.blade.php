...
@section('content')
  <div
    ...
    <div class="mb-1 w-full">
      <div class="mb-4">
        <h1 class="text-xl font-semibold text-gray-900 dark:text-white sm:text-2xl">Daftar Kategori</h1>
      </div>
      <div class="xsm:flex">
              ...
              @foreach ($categories as $category)
                <tr class="hover:bg-gray-100 dark:hover:bg-gray-700">
                  ...
                  <td class="space-x-2 whitespace-nowrap p-4">
                    ...
                    <button type="button" data-modal-target="delete-category-modal{{ $category->id }}"
  ...
  @include('categories.partials.edit_category')

  @include('categories.partials.add_category')

  @include('categories.partials.delete_category')
