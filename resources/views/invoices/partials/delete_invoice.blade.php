@foreach ($invoices as $invoice)
  <div
    ...
    id="delete-invoice-modal{{ $invoice->id }}">
      ...
      <div class="relative rounded-lg bg-white shadow dark:bg-gray-800">
        ...
        <div class="flex justify-end p-2">
          <button type="button"
            ...
            data-modal-hide="delete-invoice-modal{{ $invoice->id }}">
        ...
        <div class="p-6 pt-0 text-center">
          ...
          <h3 class="mb-6 mt-5 text-lg text-gray-500 dark:text-gray-400">Anda yakin ingin menghapus
            {{ $invoice->name }}
            ?</h3>
          <form action="{{ route('invoices.destroy', ['invoice' => $invoice->id]) }}" class="inline" method="POST">
            @method('DELETE')
            @csrf
            <button type="submit"
