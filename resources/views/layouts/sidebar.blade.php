<aside id="logo-sidebar"
  ...
  <div class="h-full overflow-y-auto bg-gray-700 px-3 pb-4 dark:bg-gray-800">
    <ul class="space-y-2 font-medium">
      ...
      <li>
        <button type="button"
          class="group flex w-full items-center rounded-lg p-2 text-base text-gray-300 transition duration-75 hover:bg-gray-100 hover:text-gray-800 dark:text-white dark:hover:bg-gray-700"
          aria-controls="dropdown-transaksi" data-collapse-toggle="dropdown-transaksi">
          <svg class="h-5 w-5 text-gray-300 group-hover:text-gray-900 dark:text-gray-400" aria-hidden="true"
