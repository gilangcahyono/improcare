...
@foreach ($materialrequests as $materialrequest)
  <div
    ...
    id="delete-materialrequest-modal{{ $materialrequest->id }}">
      ...
      <div class="relative rounded-lg bg-white shadow dark:bg-gray-800">
        ...
        <div class="flex justify-end p-2">
          <button type="button"
            ...
            data-modal-hide="delete-materialrequest-modal{{ $materialrequest->id }}">
        ...
        <div class="p-6 pt-0 text-center">
          ...
          <h3 class="mb-6 mt-5 text-lg text-gray-500 dark:text-gray-400">Anda yakin ingin menghapus
            {{ $materialrequest->name }}
            ?</h3>
          <form action="{{ route('materialrequests.destroy', ['materialrequest' => $materialrequest->id]) }}"
