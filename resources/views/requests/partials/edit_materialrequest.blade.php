...
@foreach ($materialrequests as $materialrequest)
  <div
    ...
    id="edit-materialrequest-modal{{ $materialrequest->id }}">
      ...
      <div class="relative rounded-lg bg-white shadow dark:bg-gray-800">
        ...
        <div class="flex items-start justify-between rounded-t border-b p-5 dark:border-gray-700">
          ...
          <button type="button"
            ...
            data-modal-toggle="edit-materialrequest-modal{{ $materialrequest->id }}">
            ...
            <div class="grid grid-cols-6 gap-6">
              ...
              <div class="col-span-6 sm:col-span-3">
                ...
                <input type="text" name="barcode" id="barcode"
                  ...
                  placeholder="Masukan barcode produk" disabled readonly value="{{ $materialrequest->barcode }}">
              </div>
              <div class="col-span-6 sm:col-span-3">
                <label for="name" class="mb-2 block text-sm font-medium text-gray-900 dark:text-white">Produk
                </label>
                <input type="text" name="name" id="name"
                  class="block w-full rounded-lg border border-gray-300 bg-gray-50 p-2.5 text-gray-900 shadow-sm focus:border-blue-500 focus:ring-blue-500 dark:border-gray-600 dark:bg-gray-700 dark:text-white dark:placeholder-gray-400 dark:focus:border-blue-500 dark:focus:ring-blue-500 sm:text-sm"
                  placeholder="Masukan nama" readonly disabled value="{{ $materialrequest->name }}">
              </div>
              <div class="col-span-6 sm:col-span-3">
