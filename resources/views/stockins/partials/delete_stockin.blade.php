...
@foreach ($stockins as $stockin)
  <div
    ...
    id="delete-stockin-modal{{ $stockin->id }}">
      ...
      <div class="relative rounded-lg bg-white shadow dark:bg-gray-800">
        ...
        <div class="flex justify-end p-2">
          <button type="button"
            ...
            data-modal-hide="delete-stockin-modal{{ $stockin->id }}">
        ...
        <div class="p-6 pt-0 text-center">
          ...
          <form action="{{ route('stockins.destroy', ['stockin' => $stockin->id]) }}" class="inline" method="POST">
            @method('DELETE')
            @csrf
            <button type="submit"
