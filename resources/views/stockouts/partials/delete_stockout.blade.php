...
@foreach ($stockouts as $stockout)
  <div
    ...
    id="delete-stockout-modal{{ $stockout->id }}">
      ...
      <div class="relative rounded-lg bg-white shadow dark:bg-gray-800">
        ...
        <div class="flex justify-end p-2">
          <button type="button"
            ...
            data-modal-hide="delete-stockout-modal{{ $stockout->id }}">
        ...
        <div class="p-6 pt-0 text-center">
          ...
          <h3 class="mb-6 mt-5 text-lg text-gray-500 dark:text-gray-400">Anda yakin ingin menghapus ?</h3>
          <form action="{{ route('stockouts.destroy', ['stockout' => $stockout->id]) }}" class="inline" method="POST">
            @method('DELETE')
            @csrf
            <button type="submit"
