...
@section('content')
  <div
    ...
    <div class="mb-1 w-full">
      <div class="mb-4">
        <h1 class="text-xl font-semibold text-gray-900 dark:text-white sm:text-2xl">Daftar Pemasok</h1>
      </div>
      <div class="xsm:flex">
              ...
              @foreach ($suppliers as $supplier)
                <tr class="hover:bg-gray-100 dark:hover:bg-gray-700">
                  ...
                  <td class="space-x-2 whitespace-nowrap p-4">
                    <button type="button" data-modal-target="edit-supplier-modal{{ $supplier->id }}"
                    ...
                    <button type="button" data-modal-target="delete-supplier-modal{{ $supplier->id }}"
  ...
  @include('suppliers.partials.edit_supplier')

  @include('suppliers.partials.add_supplier')

  @include('suppliers.partials.delete_supplier')
