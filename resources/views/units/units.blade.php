...
@section('content')
  <div
    ...
    <div class="mb-1 w-full">
      <div class="mb-4">
        <h1 class="text-xl font-semibold text-gray-900 dark:text-white sm:text-2xl">Daftar Satuan</h1>
      </div>
      <div class="xsm:flex">
              ...
              @foreach ($units as $unit)
                <tr class="hover:bg-gray-100 dark:hover:bg-gray-700">
                  ...
                  <td class="space-x-2 whitespace-nowrap p-4">
                    <button type="button" data-modal-target="edit-unit-modal{{ $unit->id }}"
                      data-modal-toggle="edit-unit-modal{{ $unit->id }}"
                    ...
                    <button type="button" data-modal-target="delete-unit-modal{{ $unit->id }}"
                      data-modal-toggle="delete-unit-modal{{ $unit->id }}"
  ...
  @include('units.partials.edit_unit')

  @include('units.partials.add_unit')

  @include('units.partials.delete_unit')
